...
def get_feature_description(feature):
    ...
    descriptions = {
        "Watcher": "Choose products, enjoy shopping, and provide feedback and ratings to the shopping system.",
        "Explorer": "Search for products heard of before and expand product experiences.",
        "Critic": "Demanding high standards for products and the shopping system, may criticize both the shopping system and the products.",
