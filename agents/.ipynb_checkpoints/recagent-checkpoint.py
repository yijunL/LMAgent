...
class RecAgent(GenerativeAgent):
    ...
    def take_action(self, now) -> Tuple[str, str]:
        ...
        (2) Enter the Social Media. {self.name} can chat with friends or publish a post to all friends of {self.name}. If {self.name} recently bough some products they might want to enter the Social Media, else they might want to enter the Shopping System.\n \
        (3) Do Nothing."
